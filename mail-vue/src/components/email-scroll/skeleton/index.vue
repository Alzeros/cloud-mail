      ...
      <div class="title">
        ...
        <div class="email-top">
          <div class="email-sender">
            <div class="email-status" v-if="showStatus"></div>
            <div v-else></div>
            <span class="name">
              <span>
                <el-skeleton animated>
                  <template #template>
                    <el-skeleton-item variant="text" style="width: 150px;height: 1rem;"/>
                  </template>
                </el-skeleton>
              </span>
            </span>
        ...
        <div class="email-text-skeleton">
          <el-skeleton animated>
            <template #template>
              <el-skeleton-item variant="text" style="width: 80%;height: 1rem;"/>
            </template>
          </el-skeleton>
        </div>
